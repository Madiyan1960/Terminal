...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    const materialHeaders = [
        ...
        { key: 'Кол-во на складе', label: 'Наличие (принято по акту ед.' },
        { key: 'Остаток', label: 'Остаток' },
        { key: 'Оповещение', label: 'Оповещение' }
    ];
    ...
    const balancesHeaders = [
        { key: 'ID', label: 'ID' },
        { key: 'Материал', label: 'Материал' },
        { key: 'Наличие (принято по акту ед.)', label: 'Наличие (принято по акту ед.' }, // Возможно, это не совпадает с реальным заголовком в таблице.
